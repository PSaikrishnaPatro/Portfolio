...
export function Contact() {
  ...
  const contactInfo = [
    { icon: Mail, label: "Email", value: "bantypatro2003@gmail.com" },
    { icon: Phone, label: "Phone", value: "+91 7205865058" },
    { icon: MapPin, label: "Location", value: "Berhampur, Odisha, India" },
  ];

  const quickLinks = [
    { icon: Github, url: "https://github.com/PSaikrishnaPatro" },
    { icon: Linkedin, url: "https://www.linkedin.com/in/p-saikrishna-patro-2003psp/" },
    { icon: Mail, url: "mailto:bantypatro2003@gmail.com" },
    { icon: MessageCircle, url: "https://wa.me/+917205865058" },
    { icon: Instagram, url: "https://www.instagram.com/bantypatro2003/" },
  ];
