...
export function FloatingNav() {
  const socialLinks = [
    { icon: Github, href: 'https://github.com/PSaikrishnaPatro', label: 'GitHub' },
    { icon: Linkedin, href: 'https://www.linkedin.com/in/p-saikrishna-patro-2003psp/', label: 'LinkedIn' },
    { icon: Twitter, href: '#', label: 'Twitter' },
    { icon: Instagram, href: 'https://www.instagram.com/bantypatro2003/', label: 'Instagram' },
    { 
      icon: () => (
      ...
      href: 'https://leetcode.com/u/psaikrishnapatro03/', 
      label: 'LeetCode' 
    },
    { icon: Mail, href: 'mailto:bantypatro2003@gmail.com', label: 'Email' },
  ];
